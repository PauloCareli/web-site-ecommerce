...
const UserEditScreen: React.FC<UserEditScreenProps> = ({ match, history }) => {
    ...
    const userDetails = useSelector<RootState, any>((state) => state.userDetails); // Replace 'any' with the appropriate type for the userDetails slice if available.
    const { error, loading, user } = userDetails;

    const userUpdate = useSelector<RootState, any>((state) => state.userUpdate); // Replace 'any' with the appropriate type for the userUpdate slice if available.
